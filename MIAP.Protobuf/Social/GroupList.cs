...
{
    /// <summary>
    /// 群列表信息类（Generated From Social.Proto）
    /// </summary>
    [Serializable, ProtoContract(Name = @"GroupList")]
    public partial class GroupList : IExtensible
    {
        #region 私有成员
        ...
        /// 群列表
        /// </summary>
        private List<GroupBase> m_DataList = new List<GroupBase>(0);
        ...
        public List<GroupBase> DataList
        {
