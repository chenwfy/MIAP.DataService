...
{
    /// <summary>
    /// 帖子列表信息类（Generated From Bbs.Proto）
    /// </summary>
    [Serializable, ProtoContract(Name = @"TopicList")]
    public partial class TopicList : IExtensible
    {
        #region 私有成员
        ...
        /// 帖子基本信息列表
        /// </summary>
        private List<TopicBasic> m_DataList = new List<TopicBasic>(0);
        ...
        public List<TopicBasic> DataList
        {
